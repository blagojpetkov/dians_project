package com.example.studenthelpermicroservice3.repository;


import com.example.studenthelpermicroservice3.model.Database;
...
public class UniversityRepository {
    ...
    public void gradeUniversity(Long id, Integer grade){
        File f = new File("src/main/java/com/example/studenthelpermicroservice3/database/universities.csv");
        File f1 = new File("src/main/java/com/example/studenthelpermicroservice3/database/universities1.csv");
        if(f.exists()) {
            try {
                ...
                f1.renameTo(new File("src/main/java/com/example/studenthelpermicroservice3/database/universities.csv"));
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
